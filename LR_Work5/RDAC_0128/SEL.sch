...
C {NMOS_MIN.sym} 30 120 1 0 {name=M2 model=n3.0 w=3.5u l=0.35u as=0 ps=0 ad=0 pd=0 m=1}
C {PMOS_MIN.sym} 30 -130 1 0 {name=M3 model=p3.0 w=12u l=0.35u as=0 ps=0 ad=0 pd=0 m=1}
