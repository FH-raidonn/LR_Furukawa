...
N 480 560 480 590 {lab=VSS}
N 420 590 480 590 {lab=VSS}
N -600 400 -600 430 {lab=GND}
N -500 400 -500 430 {lab=GND}
N -500 300 -300 300 {lab=Vinp}
N -700 300 -700 350 {lab=Vinp}
N -700 400 -700 430 {lab=GND}
N 420 590 420 610 {lab=VSS}
N -700 300 -500 300 {lab=Vinp}
C {code_shown.sym} 590 370 0 0 {name=s2 only_toplevel=false value=
"
VVDD VDD 0 dc 3.3
VVSS VSS 0 dc 0
VPD PD 0 dc 3.3
...
C {iopin.sym} 520 470 0 0 {name=p3 lab=OUT}
...
C {lab_pin.sym} 420 610 3 0 {name=l14 sig_type=std_logic lab=VSS}
C {cap.sym} 470 520 0 0 {name=C4
m=1
value=1p
footprint=1206
device=ceramic}
...
C {voltage.sym} -700 340 0 0 {name=V3 value=3.118}
