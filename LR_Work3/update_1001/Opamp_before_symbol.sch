...
N 360 380 360 420 {lab=OUT}
N -110 450 -110 540 {lab=#net5}
N -230 410 -150 410 {lab=#net6}
...
C {lab_pin.sym} 360 520 3 0 {name=l4 sig_type=std_logic lab=VSS}
C {ipin.sym} -360 210 0 0 {name=p3 lab=Vin+}
C {ipin.sym} -230 410 0 0 {name=p4 lab=PD}
